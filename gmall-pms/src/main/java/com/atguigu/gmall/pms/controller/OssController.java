...
public class OssController {
    ...
    public ResponseVo<Object> policy() {
        String accessId = "LTAI4G3wKvAD54r5V9z9v9fp"; // 请填写您的AccessKeyId。
        String accessKey = "74CiAHAhMEOVJehFaKCdkjWAB9YyEd"; // 请填写您的AccessKeySecret。
        String endpoint = "oss-cn-beijing.aliyuncs.com"; // 请填写您的 endpoint。
        String bucket = "gamll-0211"; // 请填写您的 bucketname 。
